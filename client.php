...
<body>
    ...
    <div id="cookie-overlay" class="cookie-overlay">
        <div class="cookie-message">
            <p>We use cookies to enhance your experience. By continuing to visit this site, you agree to our use of
                cookies.</p>
            <div>
                <button onclick="acceptCookies()" class="cookie-button">Accept Cookies</button>
                <button onclick="rejectCookies()" class="cookie-button">Decline Cookies</button>
            </div>
        </div>
    </div>
    ...
    <section id="hero" class="hero">
        ...
        <div id="window" class="window">
            <span class="close-button" onclick="closeWindow()">✖</span>
            <div class="content" style="text-align: center; overflow: auto;">
                <h2><b>WELCOME TO</b></h2>
                <h2><b>MG FOODHUB AND UNLI WINGS</b></h2>
                <p style="font-size: 20px;">"Bringing Flavor to Your Doorstep: Enjoy Our Delights from the Comfort of
                    Home!"</p>
                <p><a href="regis.php"
                        style="display: inline-block; background-color: rgba(0, 0, 255, 0.5); color: white; padding: 1px 20px; text-decoration: none; border-radius: 5px; transition: background-color 0.3s;"><b>REGISTER
                            HERE</b></a></p>
            </div>
        </div>
